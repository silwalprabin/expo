...
/// `_decorateSharedObject(prototype:in:appContext:)`, and a single `@JS init(...)` becomes an override
/// of `_constructSharedObject(this:arguments:in:appContext:)` that builds the native instance from the
